 ...
 #include <iostream>
 #include <string>
 #include "watertankDeustoNoTemperature.h"
 
 void WatertankDeustoNoTemperatureSimulation::initialize() {
 ...
 void WatertankDeustoNoTemperatureSimulation::update(double delta) {
     this->log() << "Updating simulation. Delta: " << delta << std::endl;
 
     WatertankDeustoNoTemperatureRequest request;
     ...
     this->log() << "Old volume: " << mState.volume << "; adding: " << addedWater
                 << "; removing (flow rate=" << mCurrentDemandFlowrate << "): "
                 << removedWater << std::endl;
     ...
     this->log() << "Sensors: Low (0.2): " << mState.lowSensorActive
                 << "; Mid (0.5): " << mState.midSensorActive
                 << "; High (0.8): " << mState.highSensorActive << std::endl;
     ...
     this->log() << "of: " << request.outputFlow << "; err: " << request.makeError
                 << "; res: " << request.resetError << std::endl;
