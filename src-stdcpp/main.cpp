...
#include "deusto/watertankDeustoNoTemperature.h"
...
int main(int argc, char * argv[]) {
    ...
    } else if (simulation == "watertankDeustoNoTemperature") {
        runner = new ConcreteSimulationRunner<WatertankDeustoNoTemperatureSimulation, WatertankDeustoNoTemperatureData, WatertankDeustoNoTemperatureRequest>(configuration, mode);
